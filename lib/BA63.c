...
const uint8_t charSet866[256] = {
  ...
  0xCD,0xCC,0xB9,0xDB,0xFB,0xFE,0xFD,0x00, 0x5E,0x7F,0xDB,0xB0,0xB1,0xB2,0x00,0x00,  // 0x90...0x9F 0x9A(Ль)->0xDB
  0xB5,0xC6,0x00,0x00,0x00,0x00,0x00,0x00, 0xF0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,  // 0xA0...0xAF
  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 0xF1,0xFC,0xBA,0x00,0x00,0x00,0x00,0x00,  // 0xB0...0xBF
...
//Команды - VT100
const char clearCmd[4] = {"\e[2J"};
char cpcode[3] = {0x1B, 0x52, 0x00};
char setCurPos[6] = {"\e[0;0H"};	//Y затем X
const char delEndline[4] = {"\e[0K"};
const char identificationCode[4] = {"\e[0c"};
const char unknown[15] = { 0x1B, 0x5B, 0x3F, 0x32, 0x3B, 0x30, 0x30, 0x3B, 0x32, 0x3B, 0x34, 0x3B, 0x32, 0x30, 0x63 };
...
//Шлём строку
inline void BA63_SendString(const char *string, uint8_t size)
{	
