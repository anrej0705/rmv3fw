...
extern uint16_t feed_coil_current_speed;									//X0 подающей бобины
extern uint16_t feed_coil_target_speed;										//X1 подающей бобины
extern uint16_t take_coil_current_speed;									//X0 принимающей бобины
extern uint16_t take_coil_target_speed;										//X1 принимающей бобины
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
