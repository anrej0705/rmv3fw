...
void update_screen(void)
{
	...
	strncpy(&screen_buf.first[12], ru_debug_adc, 4);
	strncpy(&screen_buf.first[17], sensor_val, 4);
	...
	sprintf(sensor_val, "%04d", i1);
	strncpy(&screen_buf.second[12], ru_debug_adc, 4);
	strncpy(&screen_buf.second[17], sensor_val, 4);
